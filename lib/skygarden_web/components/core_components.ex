defmodule SkygardenWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SkygardenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SkygardenWeb.Gettext, "errors", msg, opts)
    end
  end
