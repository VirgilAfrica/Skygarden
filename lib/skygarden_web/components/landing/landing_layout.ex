defmodule SkygardenWeb.Landing.LandingLayout do
  ...
  <div class="max-w-[90%] mx-auto flex flex-col lg:flex-row items-start justify-between w-full space-y-8 lg:space-y-0 lg:space-x-12">
      ...
      ~H"""
          <section class="w-full  mx-auto max-w-[90%] flex flex-col justify-between items-center">
            <div class="w-full flex flex-col space-y-4 items-start justify-start py-8 md:py-12">
              <div class="w-full flex flex-col lg:flex-row items-start justify-between">
                <div class="flex flex-col space-y-2">
                  <h1 class="flex space-y-2 text-[24px] md:text-[32px] font-bold">Top 10 Festivals in Kenya today</h1>
                  <p>Discover our handpicked top 10 concerts in Kenya events worth checking out</p>
                </div>
                <div class="flex items-center justify-center">
                  <button class="text-blu">
    ...
    def get_started(assigns)do
      ...
      <div class="max-w-[90%] mx-auto flex flex-col items-center justify-center space-y-4 h-full text-center">
        ...
        <p class="text-[16px] md:text-[18px] lg:max-w-[60%] mx-auto">Whether it's a concert, workshop, or conference, Sky Tickets has everything you need to organize and manage your event.</p>
  ...
  defp category_data do
    [
      %{
        category: "Technology",
        icon: "fa-solid fa-television",  # Laptop icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Music",
        icon: "fa-solid fa-music",  # Music icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Art",
        icon: "fa-solid fa-palette",  # Art icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Sport",
        icon: "fa-solid fa-running",  # Sport icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Business",
        icon: "fa-solid fa-briefcase",  # Business icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Health",
        icon: "fa-solid fa-heartbeat",  # Health icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Entertainement",
        icon: "fa-solid fa-film",  # Entertainment icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Food and Drinks",
        icon: "fa-solid fa-utensils",  # Food and Drinks icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Comedy",
        icon: "fa-solid fa-laugh-squint",  # Comedy icon
        events: "10 Events",
        path: ""
      },
      %{
        category: "Workshops",
        icon: "fa-solid fa-tools",  # Workshops icon
        events: "10 Events",
        path: ""
      },
    ]
