defmodule Skygarden.Accounts.User do
  use Ecto.Schema
 ...
 def registration_changeset(user, attrs, opts \\ []) do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Skygarden.Repo)
  ...
  """
  def valid_password?(%Skygarden.Accounts.User{hashed_password: hashed_password}, password)
